...
var selectOn = false;   // 현재 선택지창 여부 이거 삭제 후 선택지 점수 계산 함수에서 처리할 예정
...
function calPoint() {
    ...
    $("#생물쌤").val(parseInt($("#생물쌤").val()) + q[testNow][selected]["score"]["생물쌤"]);
    ...
    if (testNow==9){
        ...
        $("#r_head").html("\""+result[resultMaho]["line1"] + "\"<br>" + "\"" + result[resultMaho]["line2"] + "\"");
        $("#r_name").html(resultMaho);
        $("#anima").html(result[resultMaho]["anime"]);
...
var q = {
    1: {
        ...
        "A" : {
            ...
            "score" : {"아무": 1, "세라": 1, "유리": 0, "비키": 1, "예리": 0, "네티": 1, "레미": 2, "메이": 0, "사랑": 1, "피치": 0, "체리": 2, "생물쌤": 0, "쇼콜라": 2, "바닐라": 0}
        },
        "B" : {
            "answer" : "아침을 먹으며 점심이 뭐 나올지 생각한다. 등등 다른 재밌는 상상을 한다.",
            "score" : {"아무": 1, "세라": 2, "유리": 2, "비키": 1, "예리": 1, "네티": 2, "레미": 1, "메이": 1, "사랑": 1, "피치": 1, "체리": 1, "생물쌤": 0, "쇼콜라": 1, "바닐라": 1}
        },
        "C" : {
            "answer" : "알람이 울리기도 전에 깨서 학교 갈 준비를 한다.",
            "score" : {"아무": 1, "세라": 0, "유리": 1, "비키": 1, "예리": 2, "네티": 0, "레미": 0, "메이": 2, "사랑": 1, "피치": 2, "체리": 0, "생물쌤": 2, "쇼콜라": 0, "바닐라": 2}
        }
    },
    2: {
        "question" : "피구를 할 때 나는?",
        "A" : {
            ...
            "score" : {"아무": 1, "세라": 0, "유리": 2, "비키": 2, "예리": 0, "네티": 1, "레미": 2, "메이": 0, "사랑": 2, "피치": 1, "체리": 1, "생물쌤": 1, "쇼콜라": 2, "바닐라": 0}
        },
        "B" : {
            "answer" : "적당히 참여해야지... 열심히 피한다.",
            "score" : {"아무": 1, "세라": 2, "유리": 1, "비키": 1, "예리": 2, "네티": 1, "레미": 1, "메이": 1, "사랑": 1, "피치": 1, "체리": 2, "생물쌤": 1, "쇼콜라": 1, "바닐라": 1}
        },
        "C" : {
            "answer" : "밴치에 앉아서 친구들이 피구하는 모습을 지켜본다.",
            "score" : {"아무": 1, "세라": 1, "유리": 0, "비키": 0, "예리": 1, "네티": 1, "레미": 0, "메이": 2, "사랑": 0, "피치": 1, "체리": 0, "생물쌤": 1, "쇼콜라": 0, "바닐라": 2}
        }
    },
    3: {
        ...
        "A" : {
            ...
            "score" : {"아무": 1, "세라": 0, "유리": 2, "비키": 0, "예리": 2, "네티": 1, "레미": 2, "메이": 1, "사랑": 0, "피치": 2, "체리": 1, "생물쌤": 0, "쇼콜라": 0, "바닐라": 1}
        },
        "B" : {
            "answer" : "주님 저 애를 죽이겠습니다. 용서해주세요. (주먹으로 해결한다.)",
            "score" : {"아무": 2, "세라": 0, "유리": 1, "비키": 3, "예리": 0, "네티": 1, "레미": 0, "메이": 0, "사랑": 3, "피치": 0, "체리": 0, "생물쌤": 2, "쇼콜라": 3, "바닐라": 0}
        },
        "C" : {
            "answer" : "'언니들과 싸울 순 없지만 내 틴트도 소중한걸...'  울먹이기 시작한다.",
            "score" : {"아무": 0, "세라": 3, "유리": 0, "비키": 0, "예리": 1, "네티": 1, "레미": 1, "메이": 2, "사랑": 0, "피치": 1, "체리": 2, "생물쌤": 0, "쇼콜라": 0, "바닐라": 2}
        }
    },
    4: {
        ...
        "A" : {
            ...
            "score" : {"아무": 2, "세라": 1, "유리": 1, "비키": 1, "예리": 1, "네티": 2, "레미": 2, "메이": 0, "사랑": 2, "피치": 2, "체리": 1, "생물쌤": 1, "쇼콜라": 2, "바닐라": 0}
        },
        "B" : {
            "answer" : "'**...' 속으로 욕한 후 무시한다.",
            "score" : {"아무": 1, "세라": 0, "유리": 2, "비키": 1, "예리": 1, "네티": 0, "레미": 0, "메이": 1, "사랑": 1, "피치": 0, "체리": 0, "생물쌤": 2, "쇼콜라": 1, "바닐라": 1}
        },
        "C" : {
            "answer" : "위경련이 온 척 쓰러져 상황을 모면한다.",
            "score" : {"아무": 0, "세라": 2, "유리": 0, "비키": 1, "예리": 1, "네티": 1, "레미": 1, "메이": 2, "사랑": 0, "피치": 1, "체리": 2, "생물쌤": 0, "쇼콜라": 0, "바닐라": 2}
        }
    },
    5: {
        ...
        "A" : {
            ...
            "score" : {"아무": 2, "세라": 1, "유리": 2, "비키": 1, "예리": 2, "네티": 1, "레미": 1, "메이": 2, "사랑": 1, "피치": 1, "체리": 2, "생물쌤": 0, "쇼콜라": 1, "바닐라": 2}},
        "B" : {
            "answer" : "'친구들을 지켜야해! 한시가 바빠!' (친구들이 지켜보든 말든 화려하게 변신!)",
            "score" : {"아무": 1, "세라": 2, "유리": 1, "비키": 2, "예리": 1, "네티": 1, "레미": 2, "메이": 1, "사랑": 2, "피치": 2, "체리": 1, "생물쌤": 0, "쇼콜라": 2, "바닐라": 1}
        },
        "C" : {
            "answer" : "'호에에-' 친구들을 따라 도망친다.",
            "score" : {"아무": 0, "세라": 0, "유리": 0, "비키": 0, "예리": 0, "네티": 1, "레미": 0, "메이": 0, "사랑": 0, "피치": 0, "체리": 0, "생물쌤": 3, "쇼콜라": 0, "바닐라": 0}
        }
    },
    6: {
        ...
        "A" : {
            ...
            "score" : {"아무": 0, "세라": 0, "유리": 1, "비키": 2, "예리": 0, "네티": 1, "레미": 1, "메이": 0, "사랑": 2, "피치": 0, "체리": 0, "생물쌤": 4, "쇼콜라": 2, "바닐라": 1}
        },
        "B" : {
            "answer" : "저런 애 때문에 위험에 처할 순 없지. 일단 상황을 지켜본다. ",
            "score" : {"아무": 1, "세라": 1, "유리": 2, "비키": 0, "예리": 1, "네티": 1, "레미": 0, "메이": 2, "사랑": 0, "피치": 1, "체리": 1, "생물쌤": 0, "쇼콜라": 0, "바닐라": 2}
        },
        "C" : {
            "answer" : "'생명은 그 무엇과도 바꿀 수 없다구-!' 그 애를 구하기 위해 돌진한다.",
            "score" : {"아무": 2, "세라": 2, "유리": 0, "비키": 1, "예리": 2, "네티": 1, "레미": 2, "메이": 1, "사랑": 1, "피치": 2, "체리": 2, "생물쌤": 0, "쇼콜라": 1, "바닐라": 0}
        }
    },
    7: {
        ...
        "A" : {
            ...
            "score" : {"아무": 1, "세라": 0, "유리": 2, "비키": 3, "예리": 1, "네티": 1, "레미": 0, "메이": 1, "사랑": 3, "피치": 0, "체리": 0, "생물쌤": 2, "쇼콜라": 2, "바닐라": 1}
        },
        "B" : {
            "answer" : "\"호에에에.. 앞으로는 착하게 살도록 하세요..\" 일장 연설을 하고 돌아선다.",
            "score" : {"아무": 2, "세라": 1, "유리": 0, "비키": 0, "예리": 2, "네티": 2, "레미": 1, "메이": 2, "사랑": 0, "피치": 2, "체리": 2, "생물쌤": 0, "쇼콜라": 0, "바닐라": 2}
        },
        "C" : {
            "answer" : "'귀여운 면이 있군.' 괴수쿤과 친구를 먹는다.",
            "score" : {"아무": 0, "세라": 2, "유리": 1, "비키": 0, "예리": 0, "네티": 0, "레미": 2, "메이": 0, "사랑": 0, "피치": 1, "체리": 1, "생물쌤": 0, "쇼콜라": 1, "바닐라": 0}
        }
    },
    8: {
        ...
        "A" : {
            ...
            "score" : {"아무": 2, "세라": 0, "유리": 2, "비키": 0, "예리": 2, "네티": 1, "레미": 0, "메이": 2, "사랑": 1, "피치": 0, "체리": 1, "생물쌤": 0, "쇼콜라": 0, "바닐라": 1}
        },
        "B" : {
            "answer" : "뾰로롱-☆ 친구를 마법소녀같이 만든 후 사진을 찍어 입막음한다.",
            "score" : {"아무": 1, "세라": 1, "유리": 1, "비키": 2, "예리": 0, "네티": 1, "레미": 2, "메이": 0, "사랑": 2, "피치": 1, "체리": 0, "생물쌤": 2, "쇼콜라": 2, "바닐라": 0}
        },
        "C" : {
            "answer" : "\"나 사실... 마법소녀야.\" 솔직하게 밝힌다.",
            "score" : {"아무": 0, "세라": 2, "유리": 0, "비키": 1, "예리": 1, "네티": 1, "레미": 1, "메이": 1, "사랑": 0, "피치": 2, "체리": 2, "생물쌤": 0, "쇼콜라": 1, "바닐라": 2}
        }
    },
    9: {
        ...
        "A" : {
            ...
            "score" : {"아무": 1, "세라": 2, "유리": 0, "비키": 2, "예리": 0, "네티": 2, "레미": 2, "메이": 0, "사랑": 1, "피치": 2, "체리": 1, "생물쌤": 2, "쇼콜라": 2, "바닐라": 0}
        },
        "B" : {
            "answer" : "'그저 말을 걸어온 것 뿐이야..' (기대하지 않는다.)",
            "score" : {"아무": 0, "세라": 0, "유리": 2, "비키": 0, "예리": 1, "네티": 0, "레미": 0, "메이": 1, "사랑": 1, "피치": 0, "체리": 0, "생물쌤": 0, "쇼콜라": 0, "바닐라": 1}
        },
        "C" : {
            "answer" : "흥!! 딱히 기쁜 건 아니거든! (살짝 기대한다.)",
            "score" : {"아무": 2, "세라": 1, "유리": 1, "비키": 1, "예리": 2, "네티": 1, "레미": 1, "메이": 2, "사랑": 1, "피치": 1, "체리": 2, "생물쌤": 0, "쇼콜라": 1, "바닐라": 2}
        }
    }
}
// ..
...
var result = {
    "아무": {
        ...
        "line2" : "나의 마음을 언록!",
        "personality" : "쿨하고 무관심해보이지만 사실은 소심하고 정이 많아요.<br>어느 사람을 만나든 잘 대화하고 맞춰줄 수 있어요. 다만 그만큼 자신의 성격도 딱 잘라 말할 수 없어요.<br>자신의 진정한 성격, 가치관에 대해 많은 고민을 해요. 나를 아직 제대로는 몰라요.<br>주위 사람들에게 약간 짓궂게 대하고, 속마음을 숨기고 싶어 그렇게 대해요.<br>친구, 가족을 잘 이해하고 공감해주는 따뜻한 마음의 소유자에요. 부탁도 잘 거절 못해요.<br>말재간이 약간 없는 편이라 오해를 낳을 수 있어요. 상대를 걱정하는 진심을 전달해주면 좋겠어요.<br>솔직하지 못해요. 진지한 감정표현은 낯간지럽고, 칭찬은 부끄러워요.<br>자신에 대해 조금 매몰차요. 남을 아껴주는 만큼 나도 아껴주세요!<br>연인, 썸 문제에서는 쉽게 휘청대요.",
        "BF":"네티",
        "WF":"메이"
    },
    "세라": {
        ...
        "personality" : "밝고 활발하고 주변사람에게 먼저 다가가요. 엉뚱하고 톡톡 튀는 매력으로 모르는 사람이랑도 잘 친해져요.<br>개성이 넘치고 감정표현을 잘 해요. <br>타인을 감싸주는 포용력을 가졌어요. 주변에 친구가 많은 인기 있는 타입!<br>눈물이 많고 좀 덜렁대요. 또 다소 충동적이에요.<br>희생정신, 봉사정신이 있어요. 따뜻한 마음씨로 남에게 상처주는 것을 두려워해요.<br>좋아하는 일에 열정을 갖고 임하지만, 쉽게 싫증을 느끼기도 해요.<br>순수하고 천진난만한 면이 있어요. 거짓말을 잘 못하고 금방 티가 나요.<br>연애에도 관심이 많고 낭만적인 사랑을 원해요.",
        "BF":"유리",
        "WF":"사랑"
    },
    "유리": {
    ...
    "네티": {
        ...
        "line2" : "루루팡! 루루피! 루루~얍!",
        "personality" : "밝고 활발한 성격이지만 약간 소심해요.<br>덜렁대는 게 심해요. 약간 허당! 그래도 자기가 맡은 일에 책임감이 강해요.<br>자신의 기분, 생각을 잘 알아주는 사람에게 끌려요. 따로 말 안해도 잘 알아줬으면 좋겠어요.<br>친구가 많은 타입은 아니에요. 그래도 진짜 나를 알고 이해해주는 친구가 있어요.<br>관심의 중심에 서는 걸 바라지는 않지만, 어느 정도 관심받고 싶어해요.<br>상상력도 풍부하고 창의성 있는 사람이에요. 알록달록한 풍선 같아요.<br>낭만적인 순간, 로망 있는 연애를 꿈꿔요. 사랑에 빠지면 잘 헤어나오지 못해요.<br>감정적이고, 감정 기복이 심한 편이에요. 그래서 하는 일에 지장을 받곤 해요. 또, 충동적인 면이 있어요.<br>운동신경이 좋고 손재주가 있어요.",
        "BF":"아무",
        "WF":"유리"
    },
    "레미": {
        ...
        "line2" : "삐리카 삐리랄라 산뜻하게",
        "personality" : "같이 있으면 항상 즐거워요. 활기를 불어 넣어주는 비타민c 같은 상큼한 존재!<br>친화력이 매우 좋아서 누구와도 쉽게 친해져요. 인싸 중에 인싸에요.<br>덜렁대는 데에 프로에요! 지각, 책 두고오기 등 작은 실수를 일삼아요.<br>참견쟁이인 면이 조금 있어요. 그래도 주위 사람들이 기분 나쁠 정도는 아니에요.<br>사람들에게 상냥한 편이고 매우 유쾌해서 많이 사랑받는 타입이에요.<br>자신감이 있고 표현력이 좋아요. 리액션, 감정 표현도 잘하는 편..!<br>관계를 소중히 생각하고, 친구간 문제가 생기면 속으로 걱정이 많아져요.<br>열정이 있어 좋아하는 일에 열심이지만, 싫증도 잘 내는 성격이에요.<br>금사빠인 면이 있고 연애에 관심이 많아요. 하지만 적극적으로 표현하진 못해요.",
        "BF":"메이",
        "WF":"피치"
    },
    "메이": {
        ...
        "line2" : "빠이빠이 폰포이 부드럽게~",
        "personality" : "순하고 상냥하며, 조심스럽고 내향적인 성격을 갖고 있어요. 조곤조곤 말을 하고 차분해요.<br>관찰력이 좋고, 눈치가 있는 편이지만, 가끔 엉뚱하게 핀트를 못 잡을 때가 있어요.<br>귀엽고 아기자기한 걸 엄청 좋아해요. 껴안고 곁에 두고 싶어요.<br>자신의 의사를 똑바로 전달하지 못해 곤란할 때가 있어요. 부탁도 잘 거절 못하는 타입이에요.<br>그렇다고 이용할 생각은 NO! 속으로는 주관과 고집이 있어요.<br>낯을 가리지만, 내 주위 사람들을 잘 챙기고 소중히 여겨요.<br>예의를 지킬 줄 알고 배려가 있고 속이 깊어요.<br>정이 많아서 사람들과의 이별을 힘들어해요. 이별을 미리 걱정하기도 해요.<br>추억을 소중히 여겨요. 그리고 작은 일에도 감사하고 행복을 느껴요.",
        "BF":"레미",
        "WF":"아무"
    },
    "사랑": {
    ...
    "피치": {
        ...
        "personality" : "밝고 명랑한 주인공 포지션! 항상 샤방샤방 빛이나요.<br>좀 엉뚱하고 단순한 면이 있어요. 그런 명랑함에 사람들이 놀라요.<br>상냥해서 사람들을 많이 챙겨요. 하지만 그런 상냥함이 독이 될 때가 있어요.<br>사람에 대한 믿음을 갖고 있어요. 악당마저도 사랑을 통해 달라질 수 있어요!<br>성실하고 생활력, 자립심이 있어요. 자신의 생활 환경, 할 일을 잘 챙겨요.<br>단조롭지 않은, 모험적인 일을 즐겨요. 호기심과 용기를 갖췄어요.<br>연애에 관심이 많고 사랑에 헌신적이에요. 사랑을 위해 어떠한 역경도 불사해요.",
        "BF":"바닐라",
        "WF":"레미"
    },
    "체리": {
    ...
    "생물쌤": {
        "img":"bio.png",
        "anime": "매지컬 고삼즈",
        "line1" : "마법소녀어? 우웅~ 그게모야? 쌤은 그런 거 잘 몰라♥",
        "line2" : " ",
        "personality" : "아무래도 마법소녀는 될 수는 없겠어요! 마법소녀? 그게모야-?<br>끈기가 있다 못해 끈기가 넘쳐요. 끈끈이세요? 자신이 원하는 거에 집착이 심해요.<br>딱딱한 단호박 말투로 사람들이 좀 무서워해요. <br>현실적인 성격이고 자신의 관심사가 아니면 좀 차가워요.<br>비열하고 약삭 빠른 면이 있어요. 목적을 위해 수단을 가리지 않아요.<br>짝사랑하면 심하게 하는 스타일...! 내가 아파도 포기 못해요.<br>날 좋아해주는 사람보다 내 가슴을 뛰게 하는 사람이 좋아yo..☆",
        "BF":"쇼콜라",
        "WF":"바닐라"
    },
    "쇼콜라": {
        ...
        "personality" : "쿨하고 털털한 성격의 소유자! 쿨병이 아니고 진짜 쿨한 건데요!<br>매사 당당하고 신념이 확고해요. 답답한 건 싫어요.<br>행동력이 강해서 바라는 일을 잘 이루어 내요.<br>문제 상황에서도 강단 있게 잘 대처하는 편이에요. 크게 당황하거나 좌절하지는 않아요.<br>자기 주관과 고집이 센 편이에요. 주변 사람의 말이나 조언을 잘 듣지 않아요.<br>내 일에 간섭하는 사람 못 참아요. 내 삶은 내가 사는 거에요.<br>승부욕이 강해서 간단한 게임을 해도 이기고 싶어요. 사실 뭘 하든 기본은 해요.<br>즉흥적인 면이 있고, 스릴 있는 활동도 즐겨요.<br>호불호가 강하고 사람한테도 호불호가 확실해요. 하지만 그런 만큼 사랑도 강해요.<br>연애에서 애매한 관계, 애매한 밀당은 싫어요. 애매하면 짤이에요.",
        "BF":"생물쌤",
        "WF":"체리"
    },
    "바닐라": {
        ...
        "personality" : "상냥하고 다정하고 순진한 성격이에요. 부드럽고 담백한 바닐라 아이스 같아요.<br>소극적이지만 친구를 위해 진심어린 조언을 아끼지 않아요.<br>우정을 아끼고 진실한 사랑을 원해요. 영원한 우정과 사랑에 대한 동경이 있어요.<br>어떤 집단에서 주목받지 않는 건 상관없지만, 주위 사람들은 항상 관심을 놓지 않아 줬으면 해요.<br>외롭다는 감정에 약하고 겁이 많아요.<br>성실하고 책임감 있는 성격이에요. 재능이 있고 장점이 많아도 항상 겸손해요.<br>내면이 나름 단단하지만 틀어지면 완전 변해요. 삐뚤어지기 전에 다들 잘 하도록 하세요.<br>안정감을 바래요. 집이 좋고, 오랜 친구를 보는 게 좋아요.<br>나를 믿어주고 지지해주는 사람이 있으면 누구보다도 일을 잘 할 수 있어요! 진짜로.<br>경쟁, 싸움을 잘 즐기지 않아요. 다른 한 쪽의 아픔까지도 생각해요.",
        "BF":"피치",
        "WF":"생물쌤"
    },
}
