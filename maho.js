...
var q = {
    ...
    6: {
        ...
        "B" : {
            "answer" : "저런 애 때문에 위험에 처할 순 없지. 상황을 지켜본다. ",
...
var result = {
    ...
    "메이": {
        ...
        "line2" : "빠이빠이 폰포이 부드럽게~",
        "personality" : "순하고 상냥하며, 조심스럽고 내향적인 성격을 갖고 있어요. 조곤조곤 말을 하고 차분해요.<br>관찰력이 좋고 눈치가 있는 편이에요. 근데 가끔 엉뚱하게 핀트를 못 잡을 때가 있어요.<br>귀엽고 아기자기한 거에 껌뻑 죽어요. 껴안고 곁에 두고 싶어요.<br>자신의 의사를 똑바로 전달하지 못해 곤란할 때가 있어요. 부탁도 잘 거절 못하는 타입이에요.<br>그렇다고 이용할 생각은 NO! 속으로는 주관과 고집이 있어요.<br>낯을 가리지만, 주위 사람들을 잘 챙기고 소중히 여겨요.<br>예의를 지킬 줄 알고 배려가 있고 속이 깊어요.<br>정이 많아서 사람들과의 이별을 힘들어해요. 이별을 미리 걱정하기도 해요.<br>추억을 소중히 여겨요. 그리고 작은 일에도 감사하고 행복을 느껴요.",
        "BF":"레미",
        "WF":"아무"
    },
    "사랑": {
    ...
    "체리": {
        ...
        "line2" : "호에~~~",
        "personality" : "낙천적이고 밝은 성격을 가졌어요. 몽글몽글한 성격으로 사람들을 끌어들여요.<br>주관이 세지 않고, 기가 눌리면 말을 잘 못해요.<br>긍정적이고 따뜻한 마음씨로 세상을 봐요. 함께 있으면 마음이 포근해져요.<br>친한 사람이 짓궂게 굴어도 싸우거나 하지 않아요. 순둥순둥하고 관용적이에요.<br>가끔 우유부단한 경향이 있어요.<br>마음이 약해서 주위 일들에 안타까워하고, 상처를 주는 걸 많이 무서워해요.<br>유령이 무서워요. 그런 장난 치면 입을 봉인시킬거에요-☆<br>상대의 거짓말을 잘 구분 못해요. 순진하고 잘 믿어요.<br>여러 타입의 사람과도 잘 지낼 수 있어요. 자신을 잊지 않고 말이죠.<br>성숙하고 포용적이에요. 언쟁이 생겨도 언성을 잘 높이지 않아요.",
        "BF":"비키",
        "WF":"쇼콜라"
    },
    "중성마녀": {
